          ...
          return new Promise((resolve) => {
            ...
            onValue(homeRef, (snapshot) => {
              ...
              if (data) {
                ...
                console.log(`Found ${dataLengths[home]} falls for ${home}`);
              } else {
                dataLengths[home] = 0;
                console.log(`No data for ${home}, setting to 0`);
              }
              resolve();
            }, {
              onlyOnce: true // Add this to prevent multiple listeners
            });
          });
        })
      );
